...
SECRET_KEY = 'django-insecure-2ef5vyg1dl@r*24iu&7w)hikn+&6e)86yu18#oo02)9bytke#y'
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
# i turned the debug FALSE so i do not risk hacking and then indicate my allowed host
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Note the correct capitalization here
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'my_django_app/static')]
